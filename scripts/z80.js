...
// Z80
////////////////////////////////////////////
export function Z80(mmu, port_writer, port_reader) {
	this._mmu = mmu;
...
Z80.prototype.patchForFuse = function () {
	this._opcodes[0xCB46] = bit_n_ihl_fuse(0); // BIT 0,(HL)
	this._opcodes[0xCB4E] = bit_n_ihl_fuse(1); // BIT 1,(HL)
	this._opcodes[0xCB56] = bit_n_ihl_fuse(2); // BIT 2,(HL)
	this._opcodes[0xCB5E] = bit_n_ihl_fuse(3); // BIT 3,(HL)
	this._opcodes[0xCB66] = bit_n_ihl_fuse(4); // BIT 4,(HL)
	this._opcodes[0xCB6E] = bit_n_ihl_fuse(5); // BIT 5,(HL)
	this._opcodes[0xCB76] = bit_n_ihl_fuse(6); // BIT 6,(HL)
	this._opcodes[0xCB7E] = bit_n_ihl_fuse(7); // BIT 7,(HL)
}
